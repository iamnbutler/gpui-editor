...
1. Just make it work for the simplest possible usecase, with the simplest possible approach (likely GapBuffer-based.)
...
4. Syntax highligting???? LSP???, ??? 5. Level up the editing approach - Likely some mix of the current approach and [ropes, sumtree](https://zed.dev/blog/zed-decoded-rope-sumtree).
